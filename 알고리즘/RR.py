...
class Nom_ReadyQueue(ReadyQueue):       # 일반 큐를 사용하는 Scheduling Algorithm 전용 큐
    def __init__(self):
        self.items = []
...
class Process:
    ...
    def __str__(self):
        return "#Process" + str(self.id) + " AT = " + str(self.at) + " BT = " + str(self.r_bt) + " TT = " + str(self.tt) + " NTT = " + str(self.ntt) + " WT = " + str(self.wt) + "LEFT TIME QUANTUM = " + str(self.tq)
...
def main():
    RR(input_func()).mulitcore_processing()
